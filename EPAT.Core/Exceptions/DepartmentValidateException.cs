...
{
    /// <summary>
    /// Class chứa thông tin lỗi validate riêng của department
    /// </summary>
    /// Author: quyetnv (21/03/2022)
    public class DepartmentValidateException : Exception
    {
        /// <summary>
        /// Thông báo lỗi
        /// </summary>
        ...
        /// Author: quyetnv(21/03/2022)
        public DepartmentValidateException(string? errorMsg, List<object> listError)
        {
            ErrorMsg = errorMsg;
            Errors = listError;
        }
